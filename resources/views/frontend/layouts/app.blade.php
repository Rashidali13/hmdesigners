...
<link type="text/css" href="{{ asset('frontend/css/home.css') }}" rel="stylesheet" media="screen">
        ...
        <header id="header">
            <div class="header-holder">
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-md-3">
                        <div class="logo-bar">
                            <a href="#"><img src="{{ asset('frontend/images/logo/home-logo.png') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-md-6">
                                                ...
                                                <div class="sub-dropdown">
                                                    <div class="text-info">
                                                        ...
                                                        <div class="image-holder">
                                                            <img src="{{ asset('frontend/images/card.jpg') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <ul>
...
<!-- Core -->
<script src="{{ asset('frontend/js/customSj.js') }}"></script>
